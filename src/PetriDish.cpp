...
PetriDish::PetriDish(Vector2 _position, Sprite _sprite) :
...
void PetriDish::removeNutrient(Nutrient* nutrient) {this->nutrients.erase(std::remove(this->nutrients.begin(), this->nutrients.end(), nutrient), this->nutrients.end());}
void PetriDish::removeMicrobe(Microbe* microbe) {this->microbes.erase(std::remove(this->microbes.begin(), this->microbes.end(), microbe), this->microbes.end());}
